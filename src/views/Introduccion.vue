...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-3(data-aos="zoom-in-left")
      ...
      .col-lg-12
        p La apropiación de estos contenidos permitirá elaborar diagnósticos sólidos como insumo para el Plan de Gestión Sostenible Energética (PGSE), fortaleciendo la capacidad del aprendiz para tomar decisiones informadas que contribuyan a la reducción de la huella ecológica y al impulso de una transición energética responsable.
    
    .row.justify-content-center.align-items-center(data-aos="zoom-in-left")           
      .col-lg-12
        figure
          .video
            iframe(width="560" height="315" src="https://www.youtube.com/embed/Byh9_WDDYAk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        figcaption Video. Plan de acción ambiental y de eficiencia energética – Introducción
